    ...
    <div class="container">
        ...
        <div class="text_display">
            <div class="text_block">
                ...
                <p class="text_about">Привет, уважаемые кодеры и программисты колледжей Актюбинской области! <br>Мы рады пригласить вас на самое захватывающее событие в мире программирования - хакатон 2023 ! ! ! </p>
                ...
                <h5 class="subscript">Внимание! Участие в конкурсе допускается только среди студентов колледжей!</h5>
            </div>
        </div>
        <div class="instr">
